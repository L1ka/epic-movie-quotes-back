...
<div id="container"  style=" display: table; height: 100vh; width: 100%;  background: linear-gradient(187.16deg, #181623 0.07%, #191725 51.65%, #0D0B14 98.75%);" >
    <div style="display: table; margin: auto; margin-top: 70px">
        <img src="{{ asset('images/Notification.png') }}" alt="movie-quotes-image"  style="display:table; margin: auto;  width: 22px; height: 20px" />
    </div>

    <div style="display: table; margin: auto; margin-bottom: 73px; margin-top: 15px">

        <p style="color: #DDCCAA; text-transform: uppercase;">Movie quotes</p>
    </div>
    <div class="font-size: 16px; line-height: 24px; font-weight: 400; " id="desktop" >
        <p  style="margin-bottom: 24px; margin-left: 10%; color: #fff">Hola {{ $user }}!</p>

        <a id="btn" href="{{ $url }}"
        style="margin-left: 10%; color: #fff; font-size: 14px; padding: 7px 13px; margin-bottom: 40px; text-decoration: none; ; background-color: #E31221;  border-radius: 4px; text-align: center;">Reset Password</a>
