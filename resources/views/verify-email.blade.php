<div id="container"  style="height: 100vh; width: 100%;  background: linear-gradient(187.16deg, #181623 0.07%, #191725 51.65%, #0D0B14 98.75%);" >
    ...
    <div class="font-size: 16px; line-height: 24px; font-weight: 400;  ">
        ...
        <p  style="color: #fff; margin-left: 195px;  margin-bottom: 32px;">Thanks for joining Movie quotes! We really appreciate it. Please click the button below to verify your account:</p>
        <a id="btn" href="{{ $url }}"
        style="margin-left: 195px; color: #fff; font-size: 14px; padding: 7px 13px; margin-bottom: 40px; text-decoration: none; ; background-color: #E31221;  border-radius: 4px; text-align: center;">Verify account</a>
